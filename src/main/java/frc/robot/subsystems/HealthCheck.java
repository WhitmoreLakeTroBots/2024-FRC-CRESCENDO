...
public class HealthCheck extends SubsystemBase {
    ...
    */
    ...
    public void registerSparkMAx(String SparkName, CANSparkMax newSpark, boolean inverted, int stallLimit,
            int rollLimit, IdleMode breakMode) {
        ...
        CommonLogic.setSparkParamsBase(newSpark, inverted, stallLimit, rollLimit, breakMode);

...
public class Constants {
  ...
  public static final class Cam1Constants {
    ...
    public static final Transform3d camrobotTransform3d = new Transform3d (
      RobotMath.inchesToMeters(-12), RobotMath.inchesToMeters(-2.5), RobotMath.inchesToMeters(11.5),
      new Rotation3d (Math.toRadians(0.0), Math.toRadians(34.5), Math.toRadians(191)));
  } // -6, 0, 11.0, 0, 57, 191
  ...
  public static final class DriveConstants {
    ...
    public static final double kMaxSpeedMetersPerSecond = 6.76;
    ...
    public static final double kMagnitudeSlewRate = 1.9; // percent per second (1 = 100%)
  ...
  public static final class ModuleConstants {
    ...
    public static final double kDrivingP = 0.062; //.05
    ...
    public static final double kTurningP = 0.9438; //1
  ...
  public static final class AutoConstants {
   ...
   // public static final double kMaxAccelerationMetersPerSecondSquared = 3;
    ...
    public static final double kDrivingP = 0.853;
    public static final double kDrivingI = 0.0;
    public static final double kDrivingD = 0;
    public static final double kDrivingFF = 1 / ModuleConstants.kDriveWheelFreeSpeedRps;

    public static final double kTurningP = 0.9438;
    public static final double kTurningI = 0;
    public static final double kTurningD = 0;   
    public static final double kTurningFF = 0;
